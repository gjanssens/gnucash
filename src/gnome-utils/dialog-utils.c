...
const gchar *css_default_color = "* { }";
const gchar *css_red_color     = "* { rgb(75%, 0%, 0% }";
...
gnc_set_label_color(GtkWidget *label, gnc_numeric value)
{
    ...
    if (!provider)
    {
        ...
        gtk_css_provider_load_from_data (provider, css_default_color,
                                 sizeof (css_default_color), NULL);
    ...
    if (deficit)
        gtk_css_provider_load_from_data (provider, css_red_color,
                                 sizeof (css_red_color), NULL);
    else
        gtk_css_provider_load_from_data (provider, css_default_color,
                                 sizeof (css_default_color), NULL);
}
