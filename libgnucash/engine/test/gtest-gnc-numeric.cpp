...
TEST(gncnumeric_constructors, test_string_constructor)
{
    ...
    EXPECT_EQ(123456, simple_int.num());
    EXPECT_EQ(1, simple_int.denom());
    ASSERT_NO_THROW(GncNumeric simple_decimal("123.456", std::locale::classic()));
    GncNumeric simple_decimal("123.456", std::locale::classic());
    EXPECT_EQ(123456, simple_decimal.num());
    EXPECT_EQ(1000, simple_decimal.denom());
    ASSERT_NO_THROW(GncNumeric neg_simple_decimal("-123.456", std::locale::classic()));
    GncNumeric neg_simple_decimal("-123.456", std::locale::classic());
    EXPECT_EQ(-123456, neg_simple_decimal.num());
    EXPECT_EQ(1000, neg_simple_decimal.denom());
    ASSERT_NO_THROW(GncNumeric continental_decimal("123,456", std::locale("fr_FR")));
    GncNumeric continental_decimal("123,456", std::locale("fr_FR"));
    EXPECT_EQ(123456, continental_decimal.num());
    EXPECT_EQ(1000, continental_decimal.denom());
    ASSERT_NO_THROW(GncNumeric neg_continental_decimal("-123,456", std::locale("fr_FR")));
    GncNumeric neg_continental_decimal("-123,456", std::locale("fr_FR"));
